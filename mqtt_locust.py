...
broker_address="172.17.141.197"  # The server ip Address , The actual pressure measurement shall be based on mqtt Reality ip Make changes 
REQUEST_TYPE = 'MQTT'
...
class PublishTask(TaskSet):
    def on_start(self):
        self.client.connect(host=broker_address, port=32332, keepalive=60)
